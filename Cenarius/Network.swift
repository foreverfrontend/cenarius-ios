...
//    @discardableResult
//    public static func requset(_ urlRequest: URLRequestConvertible) -> DataRequest {
//        return Alamofire.request(urlRequest)
//    }
//    
//    @discardableResult
//    public static func request(_ url: URLConvertible, method: HTTPMethod = .get, parameters: Parameters? = nil, encoding: ParameterEncoding = URLEncoding.default, headers: HTTPHeaders? = nil) -> DataRequest {
//        return Alamofire.request(url, method: method, parameters: parameters, encoding: encoding, headers: headers)
//    }
//    
//    @discardableResult
//    public static func download(_ url: URLConvertible, method: HTTPMethod = .get, parameters: Parameters? = nil, encoding: ParameterEncoding = URLEncoding.default, headers: HTTPHeaders? = nil, to destination: DownloadRequest.DownloadFileDestination? = nil) -> DownloadRequest {
//        return Alamofire.download(url, method: method, parameters: parameters, encoding: encoding, headers: headers, to: destination)
//    }
//    
//    @discardableResult
//    public static func download(_ urlRequest: URLRequestConvertible, to destination: DownloadRequest.DownloadFileDestination? = nil) -> DownloadRequest {
//        return Alamofire.download(urlRequest, to: destination)
//    }
//
...
//    }
    ...
    public static func upload(_ fileURL: URL, with urlRequest: URLRequestConvertible) -> UploadRequest {
        return Alamofire.upload(fileURL, with: urlRequest)
    }
    ...
    public static func upload(
        ...
        -> UploadRequest
    {
        return Alamofire.upload(stream, to: url, method: method, headers: headers)
    }
    ...
    public static func upload(_ stream: InputStream, with urlRequest: URLRequestConvertible) -> UploadRequest {
        return Alamofire.upload(stream, with: urlRequest)
    }
